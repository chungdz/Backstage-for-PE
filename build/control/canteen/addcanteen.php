	...
	<form class="am-form" enctype="multipart/form-data" name="form" data-am-validator>
	  <fieldset>
			...
			<div class="am-form-group">
			  <label for="doc-ta-1">食堂名字</label>
			  <textarea class="" rows="1" name="username" id="canteen" required/></textarea>
			</div>
	...
	$("#submit").click(function(){
		...
		else
		{
			...
			//alert(canteenInfo);
			 ...
			 $.post("/PHP/canteen/addCanteen.php", canteenInfo ,
					function(data,status){
					
					let stat = data["addCanteenStatus"];
