...
<?php
	...
	$Id = $_GET["Id"];
	//获得总的条数
	$sql="SELECT COUNT(*) AS count FROM ".COMMENT_TABLE." WHERE user_id=$Id";
	...
	//获取表格数据
	$sql="SELECT comment_id,dish_id,user_id,content FROM ".COMMENT_TABLE." where user_id=$Id 
...
EOT;
	...
	<footer class="blog-footer">
		  <p>
		  <form action="usersearch.php" method="get" class="am-form-horizontal am-form-inline">
		  ...
		  <br>
			<small>
				<ul class="am-pagination"  style="text-align:center;" >
					<li><a href="usersearch.php?Page=$prev_page&Id=$Id">&laquo; Prev</a></li>
					第 $page 页 共 $total_page 页
					<li><a href="usersearch.php?Page=$next_page&Id=$Id">Next &raquo;</a></li>
				</ul>
			</small>
		  </p>
		</footer>
